<?php
$page_title       = 'About';
$page_description = 'Rely Service is a Mumbai-based partner to educational institutions, working across campus technology, student employability and incubation.';
$active           = 'about';
...
<section class="page-hero">
  <div class="container">
    <p class="breadcrumb"><a href="/">Home</a> <span aria-hidden="true">/</span> About</p>
...
<section class="section section--tint">
  <div class="container">
    <div class="section-head center">
      ...
      <h2>The principles we hold to</h2>
    </div>
    <div class="grid grid-3">
      ...
      <div class="card">
        ...
        <p>Technology, training and incubation under a single point of contact, so
           nothing falls between vendors.</p>
      </div>
      <div class="card">
...
<section class="cta-band">
  <div class="container">
    <h2>Work with us</h2>
    <p>Whether you're scoping a project or just comparing options, a conversation costs nothing.</p>
    <div class="btn-row">
