...
file is simply the tidiest option because it stays put between our conversations.
...
| Field | Your answer |
| --- | --- |
| Legal / display company name | Rely Service |
| Office address, line 1 | |
| Office address, line 2 (area, landmark) | |
| City | Mumbai |
| State | Maharashtra |
| PIN code | |
| Main phone (with country code) | |
| Main email (published on the site) | |
| Email that enquiries should be delivered to | |
...
**Button text** (default: "Talk to our team")
...
> **Note:** please confirm you hold written permission for each. Institutions
> change leadership and new heads sometimes object to a logo they never approved.
...
## 5. Incubation & Entrepreneurship page
...
**Response time promise** (default: "within two working days")
